...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<link rel="shortcut icon" href="images/lat_logo.png" type="image/vnd.microsoft.icon">
	<title>LA:T Application Server</title>
...
<body>
	<div id="container">
		...
		<div id="content">
			...
			<div>
				<p>This is the default LA:T Application Server index page, which indicates a new server instance was installed, and application is not yet deployed. It is located on the local filesystem at
				...
				<ul>
					<li>Server ID : <%= System.getProperty("lat.name") %></li>
		...
		<div id="versions">
			LA:T Web Application Server Open Edition
		</div>
